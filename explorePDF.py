...
from toolBox.structures import structureEnglish, structureSpanish  # import filtering structures
...
class explorePDF():
    def __init__(self, workPath, state, consolidate=True):
    ...
    def upgrade(self):
        ...
        auxn = upgradeCode(self.state)
        if auxn:
            self.setState('Restarting code...')
            return
