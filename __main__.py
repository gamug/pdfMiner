...
class textMiner():
    ...
    def pdfMiner(self):
        ...
        database = explorePDF(self.workPath, self.state)  # creating explorePDF object
        database.main()
        self.setState('********************************************')
    ...
    def structureAnalysis(self):
        messagebox.showinfo(message="This function is still under development... WAIT FOR IT!", title="For you information")
